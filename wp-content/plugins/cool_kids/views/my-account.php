<div class="lg:grid grid-cols-3 lg:gap-4 pt-5"> <?php # phpcs:ignore?>
	<template  x-if="isLoaded">
		<div

			x-init="myAccount.getAccount()"
			...
			<div class="flex flex-1 flex-col p-8">
				<img class="mx-auto size-32 shrink-0 rounded-full"
					x-bind:src="'https://placehold.co/100x100?text='+myAccount.initials"
					loading="lazy">
				<h3 x-text="myAccount.first_name + ' ' + myAccount.last_name" class="mt-6 text-sm font-medium text-gray-900"></h3>
				<dl class="mt-1 flex grow flex-col justify-between">
					<dt class="sr-only">Country</dt>
					<dd x-text="myAccount.country" class="text-sm text-gray-500"></dd>

					<dt class="sr-only">Role</dt>
					<dd class="mt-3">
							<span
								x-text="myAccount.role"
			...
			<div>
				<div class="-mt-px flex divide-x divide-gray-200">
					<div class="flex w-0 flex-1">
						<a x-bind:href="'mailto:' + myAccount.email"
							...
							Email : <span x-text="myAccount.email"></span>
						</a>
					</div>
